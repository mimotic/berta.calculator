...
export const INGREDIENTS: Ingredient[] = [
  { id:'patata',    label:'Patata cocida',            group:'hc',   val:110,  max:200, step:1,    isOil:false, kcal:86,  prot:2.0,  fat:0.1,  phos:35,  pot:328, carb:20,   ca:8,   na:5,   fe:0.31, zn:0.30, vitA:0,    vitD:0,    vitE:0.01, b12:0,    fiber:1.8 },
  ...
  { id:'calabacin', label:'Calabacín cocido',         group:'hc',   val:60,   max:150, step:1,    isOil:false, kcal:17,  prot:1.2,  fat:0.2,  phos:32,  pot:261, carb:3.1,  ca:18,  na:3,   fe:0.37, zn:0.20, vitA:51,   vitD:0,    vitE:0.13, b12:0,    fiber:1.0 },
  { id:'zanahoria', label:'Zanahoria cocida',         group:'hc',   val:20,   max:80,  step:1,    isOil:false, kcal:35,  prot:0.8,  fat:0.2,  phos:30,  pot:235, carb:7.9,  ca:30,  na:58,  fe:0.34, zn:0.20, vitA:852,  vitD:0,    vitE:1.03, b12:0,    fiber:2.9 },
  ...
  { id:'merluza',   label:'Merluza cocida',           group:'prot', val:70,   max:120, step:1,    isOil:false, kcal:86,  prot:15.8, fat:1.5,  phos:140, pot:302, carb:0,    ca:40,  na:90,  fe:1.00, zn:0.50, vitA:10,   vitD:1.0,  vitE:0.60, b12:2.0,  fiber:0   },
