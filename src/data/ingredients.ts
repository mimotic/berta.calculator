...
export const INGREDIENTS: Ingredient[] = [
  ...
  { id:'pollo',     label:'Pechuga de pollo cocida',  group:'prot', val:0,    max:120, step:5,    isOil:false, kcal:155, prot:31.0, fat:3.6,  phos:220, pot:256, carb:0,    ca:15,  na:74,  fe:1.04, zn:1.00, vitA:9,    vitD:0.1,  vitE:0.27, b12:0.34  },
  { id:'higado',    label:'Hígado de pollo',          group:'prot', val:0,    max:60,  step:5,    isOil:false, kcal:165, prot:25,   fat:6.5,  phos:300, pot:263, carb:0.7,  ca:11,  na:71,  fe:11.6, zn:4.30, vitA:3300, vitD:0.3,  vitE:0.70, b12:16.6  },
  { id:'clara',     label:'Clara de huevo',           group:'prot', val:35,   max:100, step:1,    isOil:false, kcal:52,  prot:10.9, fat:0.2,  phos:15,  pot:163, carb:0.7,  ca:7,   na:166, fe:0.08, zn:0.03, vitA:0,    vitD:0,    vitE:0,    b12:0.09  },
  { id:'yema',      label:'Yema de huevo',            group:'fat',  val:5,    max:20,  step:1,    isOil:false, kcal:322, prot:15.9, fat:26.5, phos:443, pot:102, carb:3.6,  ca:129, na:48,  fe:2.73, zn:2.30, vitA:381,  vitD:5.4,  vitE:2.58, b12:2.0   },
  { id:'aceite',    label:'Aceite oliva (ml)',        group:'fat',  val:0.5,  max:5,   step:0.25, isOil:true,  kcal:884, prot:0,    fat:100,  phos:0,   pot:1,   carb:0,    ca:1,   na:2,   fe:0.56, zn:0,    vitA:0,    vitD:0,    vitE:14.35,b12:0     },
]
...
export function calcNutrition(values: Values, ingredients: Ingredient[] = INGREDIENTS) {
  ...
  let ca = 0, na = 0, fe = 0, zn = 0, vitA = 0, vitD = 0, vitE = 0, b12 = 0
  ...
  return { kcal, prot, fat, carb, phos, pot, ca, na, fe, zn, vitA, vitD, vitE, b12 }
}
